...
prefect deployment build flows/parametrized.py:parametrized --name process -q prod -t project \
...
prefect deployment build flows/parametrized.py:parametrized --name process2 -q prod -t project \
...
prefect deployment build flows/parametrized.py:parametrized --name anonymous -q prod -t project \
...
prefect deployment build flows/parametrized.py:parametrized --name s3 -q prod -t project -o deploy/s3.yaml -sb s3/prod -v GITHUB_SHA
...
prefect deployment build flows/parametrized.py:parametrized --name gcs -q prod -t project -o deploy/gcs.yaml -sb gcs/prod -v GITHUB_SHA
...
prefect deployment build flows/parametrized.py:parametrized --name az -q prod -t project -o deploy/az.yaml -sb azure/prod -v GITHUB_SHA
...
prefect deployment build flows/parametrized.py:parametrized --name cron -q prod -t project -o deploy/cron.yaml --cron "*/1 * * * *"
...
pd build flows/parametrized.py:parametrized -n noupload -q prod -sb s3/prod -o deploy/noupload.yaml --skip-upload --apply

# ----------------------------------------------------------------------------------------------------------
# parametrization
# this should fail
pd build flows/parametrized.py:parametrized -n kv -q prod -o deploy/json.yaml --apply --param user=Anna --param answer=7 --params '{"user": "Brooklyn", "answer": 99}'
# Can only pass one of `param` or `params` options
pd build flows/parametrized.py:parametrized -n default -q prod -o deploy/json.yaml --apply
pd run parametrized/default

pd build flows/parametrized.py:parametrized -n json -q prod -o deploy/json.yaml --apply --params '{"user": "Brooklyn", "answer": 99}'
pd run parametrized/json

pd build flows/parametrized.py:parametrized -n kv -q prod -o deploy/json.yaml --apply --param user=Anna --param answer=7
pd run parametrized/kv

# ----------------------------------------------------------------------------------------------------------
# scheduling
pd set-schedule --cron '20 18 * * MON' --timezone 'Europe/Berlin' parametrized/default
pd set-schedule --cron '30 18 * * MON' --timezone 'Europe/Berlin' parametrized/default
